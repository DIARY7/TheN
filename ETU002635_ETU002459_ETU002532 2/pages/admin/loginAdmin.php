...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            margin: 0;
            background: url("../../image/loginAdmin.jpg") no-repeat center center fixed;
...
<body>
    <div class="content">
        ...
        <form action="traitement/login_admin.php" method="post">
           <div class="field">
              <input required="" type="text" name="login" value="Ryan" class="input">
           ...
           <div class="field">
              <input required="" type="password" name="password" value="1234" class="input">
