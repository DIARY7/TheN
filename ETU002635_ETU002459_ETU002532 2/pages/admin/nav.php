    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="accueil_admin.php">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="the.php">The</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="parcelle.php">Parcelle</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="cueilleur.php">Cueilleur</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="categorie.php">Categorie de depense</a>
                </li>
                <li class="nav-item">
